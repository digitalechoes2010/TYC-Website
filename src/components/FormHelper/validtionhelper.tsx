...
export const cnfPassword = (value: any) => (value2: any) =>
  value === value2 ? undefined : "Passwords does not match";

export const maxLength = (max: number) => (value: any) =>
  value && value.length > max ? `Must be ${max} characters or less` : undefined;
export const minLength = (min: number) => (value: any) =>
  value && value.length < min ? `Must be ${min} characters minimum` : undefined;

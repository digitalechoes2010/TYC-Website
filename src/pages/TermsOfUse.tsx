  ...
  render() {
    return (
      <Container fluid className="TermsConditions">
        <Helmet>
          <title>TYC - Terms of use</title>
        </Helmet>
        <Row>
          <Col xs={12}>
            <h1>TermsConditions</h1>
            <p className="TermsConditions-date">
            ...
            <p className="TermsConditions-Title">1. THE APPLICATION</p>
            <p className="TermsConditions-text">
            ...
            <p className="TermsConditions-Title">2. SCOPE OF LICENSE</p>
            <p className="TermsConditions-text">
            ...
            <p className="TermsConditions-Title">3. TECHNICAL REQUIREMENTS</p>
            <p className="TermsConditions-text">
            ...
            <p className="TermsConditions-Title">4. MAINTENANCE AND SUPPORT</p>
            <p className="TermsConditions-text">
            ...
            <p className="TermsConditions-Title">5. USE OF DATA</p>
            <p className="TermsConditions-text">
            ...
            <p className="TermsConditions-Title">7. CONTRIBUTION LICENSE</p>
            <p className="TermsConditions-text">
            ...
            <p className="TermsConditions-Title">8. LIABILITY</p>
            <p className="TermsConditions-text">
            ...
            <p className="TermsConditions-Title">9. WARRANTY</p>
            <p className="TermsConditions-text">
            ...
            <p className="TermsConditions-Title" id="ProductClaims">
              10. PRODUCT CLAIMS
            </p>
            <p className="TermsConditions-text">
            ...
            <p className="TermsConditions-Title">12. CONTACT INFORMATION</p>
            <p className="TermsConditions-text">
              For general inquiries, complaints, questions or claims concerning
              the licensed Application, please contact:
            </p>
            <p className="TermsConditions-text">Tap Your Chip</p>
            <p className="TermsConditions-text">15694 Beltaire Lane</p>
            <p className="TermsConditions-text">San Diego, CA 92127</p>
            <p className="TermsConditions-text">United States</p>
            <p className="TermsConditions-text">
              <a href="mailto:info@tapyourchip.com">info@tapyourchip.com</a>
            </p>
            <p className="TermsConditions-Title">13. TERMINATION</p>
            <p className="TermsConditions-text">
